INSERT INTO public.tb_endereco (rua, cidade, estado, cep, data_criacao)
VALUES
    ('Rua Exemplo', 'Cidade Exemplo', 'Estado Exemplo', '12345-678',  '2024-03-14 10:00:00'),
    ('Avenida Central', 'São Paulo', 'SP', '01234-567',  '2024-03-14 10:00:00'),
    ('Rua dos Sonhos', 'Rio de Janeiro', 'RJ', '89012-345',  '2024-03-14 10:00:00'),
    ('Jadim Botânico', 'Curitiba', 'PR', '80210-391',  now());
...
VALUES
    ...
    ('Admin', 75, 'Masculino', 'ADMIN', '12345678', 'admin@email.com', 2);
